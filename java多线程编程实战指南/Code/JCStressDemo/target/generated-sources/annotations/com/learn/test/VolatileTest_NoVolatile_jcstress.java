...
import com.learn.test.VolatileTest.NoVolatile;

public class VolatileTest_NoVolatile_jcstress extends Runner<VolatileTest_NoVolatile_jcstress.Outcome> {

    public VolatileTest_NoVolatile_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "com.learn.test.VolatileTest.NoVolatile");
    }
    ...
    private void run(Counter<Outcome> results) {
        ...
        while (System.currentTimeMillis() < target) {
            ...
            final NoVolatile state = new NoVolatile();
